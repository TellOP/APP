// <copyright file="SearchStringNetTab.xaml.cs" company="University of Murcia">
...
namespace TellOP
{
    ...
    /// </summary>
    public partial class SearchStringNetTab : ContentPage
    {
        /// <summary>
        /// Parent page
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchStringNetTab"/> class.
        /// </summary>
        /// <param name="parent">Parent page</param>
        public SearchStringNetTab(MainSearch parent)
        {
            this.Icon = "TAB_StringNet.png";
            this.Title = "Collocations";
            this.parent = parent;
            this.PreInitialize();
        ...
        {
            this.BindingContext = new StringNetSearchDataModel();
        }

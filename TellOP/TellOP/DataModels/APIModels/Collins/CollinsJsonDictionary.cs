// <copyright file="CollinsJsonDictionary.cs" company="University of Murcia">
...
namespace TellOP.DataModels.ApiModels.Collins
{
    ...
    /// </summary>
    [JsonObject]
    public class CollinsJsonDictionary
    {
        /// <summary>
        ...
        public IList<CollinsJsonDictionarySingleResult> Results { get; set; }
    }
}

...
namespace TellOP.API
{
    ...
    public class StringNet : OAuth2API
    {
        ...
        public StringNet(Account account)
            : base(
                  Config.TellOPConfiguration.GetEndpointAsUri("TellOP.API.StringNet"),
                  HttpMethod.Get,
                  account)
        {
            throw new NotImplementedException("Calling this constructor without"
                + " passing the query is not supported");
        }
        ...
        public StringNet(Account account, string query)
            : base(
                  new Uri(Config.TellOPConfiguration.GetEndpoint("TellOP.API.StringNet") + "?q="
        ...
        /// API response.
        /// </summary>
        /// <returns>A <see cref="List{StringNet}"/> containing the object
        ...
        public async Task<List<StringNet>> CallEndpointAsObjectAsync()
        {
            return JsonConvert.DeserializeObject<List<StringNet>>(

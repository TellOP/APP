// <copyright file="Adelex.cs" company="University of Murcia">
    ...
    public class Adelex : OAuth2API
    {
                  ...
                  account)
        {
            throw new NotImplementedException("Calling this constructor without"
                + " passing the text and order is not supported");
        }
        ...
        {
            return JsonConvert.DeserializeObject<AdelexResultEntry>(

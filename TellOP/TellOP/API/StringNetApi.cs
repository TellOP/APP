// <copyright file="StringNetApi.cs" company="University of Murcia">
...
namespace TellOP.Api
{
    ...
    using DataModels.ApiModels.StringNet;
    ...
    /// </summary>
    public class StringNetApi : OAuth2Api
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StringNetApi"/> class.
        /// </summary>
        /// <param name="account">The instance of the <see cref="Account"/> class to use to store the OAuth 2.0 account
        /// credentials.</param>
        public StringNetApi(Account account)
        ...
        public StringNetApi(Account account, string query)
        ...
        public async Task<StringNetSplit> CallEndpointAsObjectAsync()
        {
            return JsonConvert.DeserializeObject<StringNetSplit>(await this.CallEndpointAsync().ConfigureAwait(false));
        }
    }
}

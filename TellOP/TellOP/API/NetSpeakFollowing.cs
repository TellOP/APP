...
namespace TellOP.API
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NetSpeakFollowing"/>
        /// class.
        /// </summary>
        ...
        public NetSpeakFollowing(Account account)
            : base(
                  Config.TellOPConfiguration.GetEndpointAsUri("TellOP.API.NetSpeackFollowing"),
                  HttpMethod.Get,
                  account)
        {
        ...
        /// retrieve.</param>
        public NetSpeakFollowing(
            Account account,
            string word,
            int maxNumber)
            : base(
                  new Uri(Config.TellOPConfiguration.GetEndpoint("TellOP.API.NetSpeakFollowing") + "?q=" + Uri.EscapeDataString(word) + "&t=" + maxNumber.ToString(System.Globalization.CultureInfo.InvariantCulture)),
                  HttpMethod.Get,
                  account)
        {

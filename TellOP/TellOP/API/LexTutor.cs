// <copyright file="LexTutor.cs" company="University of Murcia">
...
namespace TellOP.API
{
    ...
    public class LexTutor : OAuth2API
    {
        ...
        /// <paramref name="textName"/> is longer than 40 characters or
        /// <paramref name="textInput"/> is longer than 400000
        ...
        public LexTutor(
            ...
            string textInput)
            : base(
                  Config.TellOPConfiguration.GetEndpointAsUri("TellOP.API.LexTutorAPIController"),
                  HttpMethod.Post,
                  account,
                  "text_name=" + Uri.EscapeDataString(Preconditions.CheckNotNull(textName)) + "&text_input=" + Uri.EscapeDataString(Preconditions.CheckNotNull(textInput)))
        {
            if (textName.Length > 40)
            {
                throw new ArgumentException(
                    "The text name can not be longer than 40 characters",
                    "textName");
            }
            ...
            {
                throw new ArgumentException(
                    "The text can not be longer than 400000 characters",
                    "textName");
            }
        }
        ...
        /// API response.
        /// </summary>
        /// <returns>An instance of <see cref="LexTutorResultEntry"/> containing
        /// the object representation of the API response.</returns>
        public async Task<LexTutorResultEntry> CallEndpointAsObjectAsync()
        {
            return JsonConvert.DeserializeObject<LexTutorResultEntry>(

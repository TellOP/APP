// <copyright file="SearchNetSpeakTab.xaml.cs" company="University of Murcia">
...
namespace TellOP
{
    ...
    /// </summary>
    public partial class SearchNetSpeakTab : ContentPage
    {
        /// <summary>
        /// Parent page
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchNetSpeakTab"/> class.
        /// </summary>
        /// <param name="parent">Parent page</param>
        public SearchNetSpeakTab(MainSearch parent)
        {
            this.Icon = "TAB_NetSpeak.png";
        ...
        {
            this.BindingContext = new NetSpeakSearchDataModel();
        }
